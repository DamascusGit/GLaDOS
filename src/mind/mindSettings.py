...
class	TheMindSettings:
	...
	_DEFAULT_PERSONA_NAME		=	"Yugeto Yashime"	# Because we built GLaDOS for her.
	_DEFAULT_PERSONA_ID			=	"Yugeto"		# Use this in her input prompts.
	_DEFAULT_PERSONA_USERNAME	=	"yugeto"		# Unix user account to run GLaDOS under.
